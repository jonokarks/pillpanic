...
export const SPAWN_COOLDOWN_MS = 600;
// capsulesPlaced thresholds at which a 2nd and 3rd simultaneous capsule start appearing
export const CONCURRENT_PILL_THRESHOLDS = [8, 20];
export const MAX_CONCURRENT_PILLS = 3;
